...
1. 먼저 작품과 각 고유명사의 문화적 배경을 문맥으로 판단한다.
2. 실제 중국 인명·지명·문파·조직은 원문 한자를 확인하여 자연스러운 한국 한자음으로 옮긴다.
3. 중국어로 음차된 서양·외국·판타지 고유명사는 원래 발음을 복원하여 한국어 외래어 표기로 옮긴다.
4. 외국 이름을 한자별 한국 한자음으로 기계적으로 읽지 않는다. 예: 丹尼尔은 단니이가 아니라 다니엘, 威尔逊은 위이손이 아니라 윌슨으로 표기한다.
5. 일본 고유명사는 일본식 독음을 사용한다.
6. 용어집에 지정된 표기는 다른 규칙보다 우선하며 작품 전체에서 일관되게 사용한다.
7. 원문의 의미와 분위기를 살리되 자연스러운 한국 웹소설 문체로 번역한다.
8. 내용을 임의로 추가하거나 삭제하지 않고 대사와 서술의 줄바꿈 구조를 가능한 한 유지한다.`;
